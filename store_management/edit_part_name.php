...
<!-- Left Panel -->
            ...
            <div class="col-sm-4">
                <div class="page-header float-left" style="padding-top: 5px;">
                    <div class="page-title">
                       ...
                       <a href="" style="border-radius: 5px"><b>Part Name</a>
 ...
 if (isset($_POST['part_name_update'])) {
       ...
       $update = "UPDATE `part_name` SET part_name = '$part_name',status = '$status' WHERE  p_n_id ='$id'"; 
       ...
       if ($result) {
              ...
              $fetch_sales = "SELECT * FROM `part_name` WHERE p_n_id ='$id'";
                    ...
                    <form method="POST">
                        <div class="container"> 
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="part_name" placeholder="Vechicle Part Comapny" value="<?= $part_name ?>" class="form-control" required="" minlength="1" maxlength="50">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group pull-right" >
                                    <button type="submit" name="part_name_update" class="btn btn-success" style="border-radius: 4px">Update
                                    </button>
