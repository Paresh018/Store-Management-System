  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <?php include 'nav_bar.php' ?>  
     ...
     if (isset($_POST['sales_submit'])) {
       ...
       $sales_insert = "INSERT INTO `sales` (`sales_id`,`consumers_name`,`mobile`,`address`,`gst_amount`,`vehicle_company`,`vehicle_name`,`part_company`,`part_name`,`price`,`quantity`,`sub_total`,`gst`,`total_amount`) VALUES ('$sales_id','$consumers_name','$mobile','$address','$gst_amount','$vehicle_company','$vehicle_name','$part_company','$part_name','$price','$quantity','$sub_total','$gst','$total_amount')";
               ...
               <div class="form-row">
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Customer Name</label>
                     <input type="text" name="consumers_name" class="form-control" placeholder="Enter Customer Name" required=""></span>
                     <input type="text" hidden name="sales_id" value="<?= $value ?>">
