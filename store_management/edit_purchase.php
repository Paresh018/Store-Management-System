  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <?php include 'nav_bar.php' ?>  
            ...
            <div class="col-sm-4">
                <div class="page-header float-left" style="padding-top: 5px;">
                    <div class="page-title">
                       ...
                       <a href="sales.php"><b>Purchase Order</b></a>
     ...
     if (isset($_POST['purchase_update'])) {
       ...
       $update = "UPDATE `purchase` SET purchase_id = '$purchase_id',supplier_name = '$supplier_name',gst_number = '$gst_number',mobile = '$mobile',address = '$address',gst_amount = '$gst_amount',vehicle_company = '$vehicle_company',vehicle_name = '$vehicle_name',part_company = '$part_company',part_name = '$part_name',price = '$price',quantity = '$quantity',sub_total = '$sub_total',gst = '$gst',total_amount = '$total_amount' WHERE  purchase_id ='$invoice'"; 
       ...
       if ($result) {
              ...
              $fetch_purchase = "SELECT * FROM `purchase` WHERE purchase_id ='$invoice'";
              $confirm = mysqli_query($con, $fetch_purchase);
            ...
            <div class="row">
               ...
               <div class="form-row">
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Customer Name</label>
                     <input type="text" name="supplier_name" value="<?= $supplier_name ?>" class="form-control" placeholder="Enter Customer Name" required=""></span>
                     <input type="text" hidden name="purchase_id" value="<?= $invoice ?>">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                     <label>GST Number <small>  (Supplier)</small></label>
                         <input type="text" name="gst_number" value="<?= $gst_number ?>" placeholder="Enter GST Number" class="form-control" required="" minlength="1" maxlength="50">
                  </div>
                </div>
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Vechicle Company</label><br>
                        <select name="vehicle_company" class="form-control" required="">
                            ...
                            <?php 
                              $fetch_purchase = "SELECT * FROM `vehicle_company`";
                                $confirm = mysqli_query($con, $fetch_purchase);
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                       <label>Vehicle Name</label>
                          <select name="vehicle_name" class="form-control" required="">
                            ...
                            <?php 
                                  $fetch_purchase = "SELECT * FROM `vehicle_name`";
                                  $confirm = mysqli_query($con, $fetch_purchase);
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Company Part</label><br>
                        <select name="part_company" class="form-control" required="">
                           ...
                           <?php 
                                 $fetch_purchase = "SELECT * FROM `part_company`";
                                  $confirm = mysqli_query($con, $fetch_purchase);
                       ...
                       <label>Part Name</label>
                          <select name="part_name" class="form-control" required="">
                            <option selected value="<?= $part_name ?>"><?= $part_name ?></option>
                             <?php 
                                  $fetch_purchase = "SELECT * FROM `part_name`";
                                    $confirm = mysqli_query($con, $fetch_purchase);
             ...
             <div class="col"></div>
              <div class="col-sm-12 col-md-12">
                ...
                <button type="submit" name="purchase_update" class="btn btn-success" style="border-radius: 4px">Update
                </button>
