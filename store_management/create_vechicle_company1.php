    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand">Store Management</a>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><a href="dash_home.php" class="active">Home</a></h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container"> 
          <div class="col-md-6">
            ...
            <div class="form-group">
                <label>Vechicle Comapny</label>
                <input type="text" name="" placeholder="Vechicle Comapny" class="form-control" required="" minlength="1" maxlength="50">
       
              <div class="invalid-feedback">
                 Please Enter Vechicle Company
                </div>
                ...
                <label>Status</label><br>
                    <span>
                      <select  required class="form-control" >
                                ...
                                <option value="Maharashtra">Active</option>
                                <option value="Karnataka">Inactive</option>
                     </select>
                        <div class="invalid-feedback">
