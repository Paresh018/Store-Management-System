...
<!-- Left Panel -->
            ...
            <div class="col-sm-4">
                <div class="page-header float-left" style="padding-top: 5px;">
                    <div class="page-title">
                       ...
                       <a href=""  style="border-radius: 5px"><b>Company Part</b></a>
 ...
 if (isset($_POST['part_update'])) {
       ...
       $update = "UPDATE `part_company` SET part_company = '$part_company',status = '$status' WHERE  p_c_id ='$id'"; 
       ...
       if ($result) {
                echo "<script>
                       swal({title: 'Success!',
                      text: 'Part Company Data Updated Successfully!',
                      icon: 'success',
              ...
              echo "<script>
               ...
               $fetch_sales = "SELECT * FROM `part_company` WHERE p_c_id ='$id'";
                    ...
                    <form method="POST">
                        <div class="container"> 
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="vehicle_part_company" placeholder="Vechicle Part Comapny" value="<?= $part_company ?>" class="form-control" required="" minlength="1" maxlength="50">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group pull-right" >
                                    <button type="submit" name="part_update" class="btn btn-success" style="border-radius: 4px">Update
                                    </button>
