...
<!--    <?php include 'config/verify.php'; ?> -->
  ...
  <div class="testbox" style="height: 330px;margin-top: 120px;">
  <h1>Login</h1>
  ...
  <center><button type="submit" class="button btn btn-info" name="login">Login</button></center>
  <center>Dont Have Account? New User?<a href="registration.php">Register Here</a></center>
  </form>
</div>
