...
<!-- Left Panel -->
            ...
            <div class="col-sm-4">
                <div class="page-header float-left" style="padding-top: 5px;">
                    <div class="page-title">
                       ...
                       <a href=""  style="border-radius: 5px">Create Vechilcle Company</a>
 ...
 if (isset($_POST['vehicle_update'])) {
       ...
       $update = "UPDATE `vehicle_company` SET vehicle_company = '$vehicle_company',status = '$status' WHERE  v_c_id ='$id'"; 
       ...
       if ($result) {
                echo "<script>
                       swal({title: 'Success!',
                      text: 'Vehicle Company Data Updated Successfully!',
                      icon: 'success',
             ...
             $fetch_sales = "SELECT * FROM `vehicle_company` WHERE v_c_id ='$id'";
                    ...
                    <form method="POST">
                        <div class="container"> 
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="vehicle_company" placeholder="Vechicle Part Comapny" value="<?= $vehicle_company ?>" class="form-control" required="" minlength="1" maxlength="50">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group pull-right" >
                                    <button type="submit" name="vehicle_update" class="btn btn-success" style="border-radius: 4px">Update
                                    </button>
