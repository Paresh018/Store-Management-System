  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <?php include 'nav_bar.php' ?>  
            ...
            <div class="col-sm-4">
                <div class="page-header float-left" style="padding-top: 5px;">
                    <div class="page-title">
                       ...
                       <a href="purchase_order.php"><b>Purchase Order</b></a>
     ...
     if (isset($_POST['sales_submit'])) {
       ...
       $sales_insert = "INSERT INTO `purchase` (`purchase_id`,`supplier_name`,`mobile`,`address`,`gst_number`,`gst_amount`,`vehicle_company`,`vehicle_name`,`part_company`,`part_name`,`price`,`quantity`,`sub_total`,`gst`,`total_amount`) VALUES ('$purchase_id','$supplier_name','$mobile','$address','$gst_number','$gst_amount','$vehicle_company','$vehicle_name','$part_company','$part_name','$price','$quantity','$sub_total','$gst','$total_amount')";

       $check = mysqli_query($con, $sales_insert);
       if ($check) {
                echo "<script>
                       swal({title: 'Success!',
            ...
            <div class="row">
               ...
               <div class="form-row">
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Supplier Name</label>
                     <input type="text" name="supplier_name" class="form-control" placeholder="Enter Supplier Name" required=""></span>
                     <input type="text" hidden name="purchase_id" value="<?= $value ?>">
                     <input type="text" hidden name="gst_amount" value="">
                  </div>  
                  <div class="form-group col-md-6 col-sm-6">
                     <label>Mobile Number</label>
                     <input type="text" name="mobile" placeholder="Enter Mobile Number" class="form-control" required="" minlength="1" maxlength="50">
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6 col-sm-6">
                     <label>Address</label>
                         <input type="text" name="address" placeholder="Enter Customer Address" class="form-control" required="" minlength="1" maxlength="50">
                  </div>
                  <div class="form-group col-md-6 col-sm-6">
                     <label>GST Number <small>  (Supplier)</small></label>
                         <input type="text" name="gst_number" placeholder="Enter GST Number" class="form-control" required="" minlength="1" maxlength="50">
                  </div>
                </div>
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Vechicle Company</label><br>
                        <select name="vehicle_company" class="form-control" required="">
                            <option selected disabled>Select Vechicle Company</option>
                            <?php 
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                       <label>Vehicle Name</label>
                          <select name="vehicle_name" class="form-control" required="">
                            <option selected disabled>Select Vehicle Name</option>
                            <?php 
                  ...
                  <div class="form-group col-md-6 col-sm-6">
                    <label>Company Part</label><br>
                        <select name="part_company" class="form-control" required="">
                            <option selected disabled>Select Company Part</option>
                           <?php 
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                       ...
                       <input type="text" name="price" class="form-control" placeholder="Price" onkeyup="onlybill()">
                  </div>
                    ...
                    <label>Quantity</label>
                     <div class="num-block skin-1" align="center">
                        <div class="num-in">
                          ...
                          <input type="text" class="in-num" onchange="onlybill()" name="quantity" value="1" readonly="">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6 col-sm-6">
                    ...
                    <span><input type="text" name="sub_total" class="form-control" readonly  placeholder="Sub Total Bill"></span>
                  </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6 col-sm-6">
                       ...
                       <input type="text"  class=" form-control" name="total_amount" placeholder="Total Bill" readonly>
                  </div>
                </div>
             ...
             <div class="col"></div>
              <div class="col-sm-12 col-md-12">
                ...
                <button type="submit" name="sales_submit" class="btn btn-success" style="border-radius: 4px">Create
                </button>
